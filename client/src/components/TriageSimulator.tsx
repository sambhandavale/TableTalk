        ...
        <div className="lg:col-span-4 liquid-glass-card dot-grid p-6 flex flex-col justify-between h-full border border-[var(--brand-border)] bg-[var(--brand-card)] transition-colors duration-300">
          ...
          <div className="relative z-10 space-y-6">
            <div className="flex justify-between items-center pb-3 border-b border-[var(--brand-border)] transition-colors duration-300">
              <span className="text-[9px] uppercase tracking-wider text-[var(--text-dim)] font-mono font-bold transition-colors duration-300">Diner Device Screen</span>
              <span className="text-[8px] bg-[var(--brand-border-subtle)] px-2 py-0.5 rounded text-[var(--text-muted)] font-mono transition-colors duration-300">Table 4 QR Scan</span>
            </div>

            {/* Star selector */}
            <div className="space-y-3">
              <label className="text-xs text-[var(--text-muted)] block font-medium transition-colors duration-300">1. Tap a star to rate your food today:</label>
            ...
            <div className="space-y-4 text-xs font-sans">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <span className="text-[var(--text-dim)] block text-[9px] uppercase tracking-wide transition-colors duration-300">Diner Name</span>
                  <input 
                    type="text" 
                    value={dinerName}
                ...
                <div className="space-y-1">
                  <span className="text-[var(--text-dim)] block text-[9px] uppercase tracking-wide transition-colors duration-300">Ordered Item</span>
                  <select 
                    value={orderedItem}
              ...
              <div className="space-y-1">
                <span className="text-[var(--text-dim)] block text-[9px] uppercase tracking-wide transition-colors duration-300">Diner Comment (Optional)</span>
                <textarea 
                  rows={2}
                  disabled
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="bg-[var(--background)] border border-[var(--brand-border)] p-4 rounded-xl flex items-center justify-between gap-4 transition-colors duration-300">
                <div className="text-left font-sans text-xs">
                  <span className="text-[8px] text-[var(--text-dim)] uppercase block transition-colors duration-300">Diner Coupon Reward</span>

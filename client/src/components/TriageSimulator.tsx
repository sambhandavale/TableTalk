...
export default function TriageSimulator() {
  ...
  return (
    ...
    >
      ...
      <section
        id="triage-simulator"
        className="py-24 max-w-7xl mx-auto px-6 md:px-12 relative z-10 text-left font-sans transition-colors duration-300"
      >
        {/* Title Explainer Block */}
        <div className="max-w-3xl mb-16 space-y-3">
          <span className="text-xs font-bold text-brand-purple-text uppercase tracking-widest block">
            Core Funnel Mechanic
          </span>
          <h3 className="text-3xl sm:text-4xl text-[var(--foreground)] font-extrabold tracking-tight transition-colors duration-300">
            How Unhappy Customers are Intercepted Privately, While Happy
            Customers Boost Your Google Presence
          </h3>
          <p className="text-xs text-[var(--text-muted)] font-sans max-w-lg font-light leading-relaxed transition-colors duration-300">
            The smart QR triage engine splits feedback based on ratings. Happy
            customers are routed online to drive public ratings. Unhappy
            customers are intercepted privately so you can rescue them before
            they leave.
          </p>
        </div>
          ...
          <div className="lg:col-span-4 p-6 flex flex-col justify-between h-full bg-black/40 border border-white/10 backdrop-blur-md rounded-2xl transition-colors duration-300">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-3">
                <label className="text-xs text-[var(--text-muted)] block font-medium transition-colors duration-300">
                  1. Tap a star to rate your experience today:
                </label>
              ...
              <div className="space-y-4 text-xs font-sans">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    value={
                      rating <= 3
                        ? "Wait took too long, service was poor."
                        : "Service was fantastic and highly professional!"
                    }
            ...
            <div className="pt-6 border-t border-[var(--brand-border)] text-[10px] text-[var(--text-muted)] leading-normal transition-colors duration-300">
              {rating >= 4 ? (
                <span className="text-green-400 font-medium">
                  ✔ Currently simulating Happy Customer flow.
                </span>
              ) : (
                <span className="text-red-400 font-medium">
                  ⚠ Currently simulating Complaint Triage flow.
                </span>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
            ...
            <div
              className={`p-6 flex flex-col justify-between transition-all duration-300 border backdrop-blur-md rounded-2xl ${
                rating >= 4
                  ? "border-green-500/60 bg-green-500/10 shadow-[0_0_30px_rgba(74,222,128,0.08)] scale-[1.01]"
                  : "border-white/10 bg-black/40 opacity-40 grayscale"
              }`}
            >
              <div className="liquid-glass-glow" />
              <div className="relative z-10 space-y-4">
                ...
                <div className="space-y-1">
                  <h4 className="text-sm font-bold text-[var(--foreground)] transition-colors duration-300">
                    Automated Google Maps Boost
                  </h4>
                  <p className="text-xs text-[var(--text-muted)] font-light leading-relaxed transition-colors duration-300">
                    Positive score detected. The customer is automatically
                    prompted to paste their {rating}-star rating onto Google. To
                    incentivize them, a dynamic loyalty coupon is sent:
                  </p>
                </div>
                ...
                <div className="pt-2 border-t border-[var(--brand-border)] text-[9.5px] text-[var(--text-muted)] space-y-1.5 transition-colors duration-300">
                  ...
                  <p className="leading-relaxed">
                    📈 Skyrockets your public Google Map reviews count by up to{" "}
                    <strong>40%</strong>, lifting local SEO search ranking
                    prominence without marketing budgets.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className="space-y-1">
                  <h4 className="text-sm font-bold text-[var(--foreground)] transition-colors duration-300">
                    Private Customer Rescue Loop
                  </h4>
                  <p className="text-xs text-[var(--text-muted)] font-light leading-relaxed transition-colors duration-300">
                    Negative rating intercepted privately. An alarm raises
                    instantly on the owner's dashboard and a custom apologetic
                    SMS recovery voucher is drafted:
                  </p>
                </div>
                ...
                <div className="bg-[var(--background)] border border-[var(--brand-border)] p-3.5 rounded-xl space-y-2 transition-colors duration-300">
                  <div className="flex justify-between items-center text-[8.5px]">
                    ...
                    <span className="text-[var(--text-dim)] transition-colors duration-300">
                      To: +91 99999 88888
                    </span>
                  </div>

                  <p className="text-[10px] text-[var(--foreground)]/80 italic leading-relaxed font-sans transition-colors duration-300">
                    "Dear {dinerName}, we apologize deeply for the delay
                    regarding your {orderedItem}. Please accept voucher SORRY20
                    for a free add-on next time."
                  </p>

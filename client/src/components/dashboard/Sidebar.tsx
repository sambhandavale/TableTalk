    ...
    >
      ...
      <div className="flex-1 py-4 flex flex-col px-3 overflow-y-auto no-scrollbar space-y-1 custom-scrollbar">
        ...
        {openSections.intelligence && (
          <div className="space-y-0.5 ml-1 border-l border-[#1e293b] pl-2">
            <NavItem tab="ai_insights" icon={BrainCircuit} label="AI Insights" />
            <NavItem tab="recommendations" icon={Lightbulb} label="Recommendations" />
            <NavItem tab="competitor_watch" icon={Crosshair} label="Competitor Watch" />
          </div>
        )}
        ...
        {openSections.customers && (
          <div className="space-y-0.5 ml-1 border-l border-[#1e293b] pl-2">
            ...
            <NavItem tab="retention" icon={Megaphone} label="Retention Campaigns" />
          </div>
        )}
        ...
        {openSections.reputation && (
          <div className="space-y-0.5 ml-1 border-l border-[#1e293b] pl-2">
            <NavItem tab="response_queue" icon={Inbox} label="Response Queue" disabled />
            <NavItem tab="review_alerts" icon={Bell} label="Review Alerts" disabled />
